...
function Navbar() {
    ...
    return (
        <div className="flex flex-col w-full h-fit fixed top-0 left-0 z-20">
            ...
            <div className="w-full fixed border-b px-[16px] sm:px-[24px] md:px-[51px] border-gray-900 h-[55px] flex items-center justify-between">
...
{
                isOpen && (<div
                    className={`w-full fixed top-[55px] left-0 bg-background items-center flex md:hidden border-b border-gray-900 flex flex-col justify-center gap-6 z-10
